...
caminho_arquivo, extensão_arquivo = os.path.splitext(arquivo)
print(caminho_arquivo, extensão_arquivo)
print(os.path.exists(caminho))
print(os.path.exists(r"D:\GIT\Curso-Python-3\Seção 06"))
print(os.path.basename(caminho))  # Caminho absoluto
print(os.path.basename(diretorio))  # Caminho absoluto
