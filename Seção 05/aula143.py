...
# classe abstrata que não tem o metodo abstrato e assim podendo ser instanciada
class AbstractFoo(ABC):
    ...
    @name.setter
    @abstractmethod  # Sempre deixar abstractmethod mais internamente (a ordem importa)
    def name(self, name): ...
