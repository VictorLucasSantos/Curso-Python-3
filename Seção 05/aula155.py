...
# cria a classe, executando ações antes da criação da classe (manipulando)
class Meta(type):
    def __new__(mcs, name, bases, dct):
        print("METACLASS NEW")
        cls = super().__new__(mcs, name, bases, dct)
        cls.__repr__ = meu_repr
        # fazendo com que seja implementado o metodo falar (podendo ser "burlado por uma propriedade")
        # e assim adicionando a outra condição pra verificar se é de fato um metodo
