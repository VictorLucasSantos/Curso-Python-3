...
Enums em python:
  ...
  - podem ser iterados para retornar seus membros canônicos na ordem de definição enum.
  Enum é a superclasse para suas enumerações. Mas também pode ser usada
...
def mover(direcao: Direcoes):
    ...
    print(f"Mover para {direcao} ({direcao.value})")
